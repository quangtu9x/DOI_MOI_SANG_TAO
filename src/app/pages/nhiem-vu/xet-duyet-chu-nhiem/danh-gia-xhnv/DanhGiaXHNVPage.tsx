...
import { DanhGiaXHNVTable } from './components/DanhGiaXHNVTable';

export const DanhGiaXHNVPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thông tin Đánh giá hồ sơ nhiệm vụ XHNV'}</h3>
          ...
          <DanhGiaXHNVTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
