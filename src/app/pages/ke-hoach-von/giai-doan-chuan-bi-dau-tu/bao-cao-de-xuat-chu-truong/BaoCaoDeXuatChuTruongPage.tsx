...
import { BaoCaoDeXuatChuTruongTable } from './components/BaoCaoDeXuatChuTruongTable';
import { BaoCaoDeXuatChuTruongModal } from './components/BaoCaoDeXuatChuTruongModal';

export const BaoCaoDeXuatChuTruongPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          ...
          <div className="card-body p-0">
            <BaoCaoDeXuatChuTruongTable searchData={searchData} />
          </div>
        </div>
      </Content>
      <BaoCaoDeXuatChuTruongModal />
    </>
  );
};
