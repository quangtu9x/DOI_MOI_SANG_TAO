...
import { HDNTChinhThucTable } from './components/HDNTChinhThucTable';

export const HDNTChinhThucPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thông tin Hội đồng nghiệm thu chính thứch'}</h3>
          ...
          <HDNTChinhThucTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
