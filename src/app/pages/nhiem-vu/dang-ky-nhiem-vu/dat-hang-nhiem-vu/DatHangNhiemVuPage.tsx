...
import { DatHangNhiemVuTable } from './components/DatHangNhiemVuTable';

export const DatHangNhiemVuPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Đăng ký đề xuất/ đặt hàng nhiệm vụ'}</h3>
          ...
          <DatHangNhiemVuTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
