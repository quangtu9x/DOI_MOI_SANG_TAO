...
import { IHoSoSangKien, INguoiThamGia, IPaginationResponse, IResult, IUserDetails, TrangThaiHoSoSangKien } from '@/models';
...
export const TiepNhanHoSoDetailModal = props => {
  ...
  const onFinish = async (trangThaiHoSoSangKien: TrangThaiHoSoSangKien = dataModal?.trangThai ?? TrangThaiHoSoSangKien.ChoTiepNhan) => {
        ...
        {!dataModal?.readOnly && (
          <>
            <div className="d-flex justify-content-center  align-items-center">
              <Button className="btn-sm btn-primary rounded-1 p-2  ms-2" onClick={() => onFinish(dataModal?.trangThai ?? TrangThaiHoSoSangKien.ChoTiepNhan)} disabled={buttonLoading}>
