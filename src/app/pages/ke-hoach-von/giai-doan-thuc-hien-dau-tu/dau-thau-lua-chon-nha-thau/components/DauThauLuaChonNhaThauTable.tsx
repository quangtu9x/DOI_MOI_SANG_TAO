...
import { useDauThauLuaChonNhaThauTable } from './useDauThauLuaChonNhaThauTable';

interface DauThauLuaChonNhaThauTableProps {
...
export const DauThauLuaChonNhaThauTable: React.FC<DauThauLuaChonNhaThauTableProps> = ({
  searchData,
  projectProcessExecutionId,
}) => {
  const dispatch: AppDispatch = useDispatch();
  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } =
    useDauThauLuaChonNhaThauTable({ searchData, projectProcessExecutionId });
