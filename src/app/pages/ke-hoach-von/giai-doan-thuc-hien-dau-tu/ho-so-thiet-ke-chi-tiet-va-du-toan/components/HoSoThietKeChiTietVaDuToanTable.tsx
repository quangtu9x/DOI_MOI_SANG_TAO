...
import { useHoSoThietKeChiTietVaDuToanTable } from './useHoSoThietKeChiTietVaDuToanTable';

interface HoSoThietKeChiTietVaDuToanTableProps {
...
export const HoSoThietKeChiTietVaDuToanTable: React.FC<HoSoThietKeChiTietVaDuToanTableProps> = ({
  searchData,
  projectProcessExecutionId,
}) => {
  const dispatch: AppDispatch = useDispatch();
  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } =
    useHoSoThietKeChiTietVaDuToanTable({ searchData, projectProcessExecutionId });
