...
import { InvestmentCapitalSourceTable } from './components/InvestmentCapitalSourceTable';
import { InvestmentCapitalSourceDetailModal } from './components/InvestmentCapitalSourceDetailModal';

export const DanhMucNguonVonDauTuPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Danh mục nguồn vốn đầu tư'}</h3>
          ...
          <InvestmentCapitalSourceTable searchData={searchData} />
        </div>
        <InvestmentCapitalSourceDetailModal />
      </Content>
    </>
  );
};
