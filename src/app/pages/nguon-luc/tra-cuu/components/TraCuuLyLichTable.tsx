...
import { useTraCuuLyLichTable } from './useTraCuuLyLichTable';
import { TraCuuLyLichDetailModal } from './TraCuuLyLichDetailModal';
...
export const TraCuuLyLichTable: React.FC<DataTableProps> = ({ searchData }) => {
  const dispatch: AppDispatch = useDispatch();
  const modalVisible = useSelector((state: RootState) => state.modal.modalVisible);

  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } = useTraCuuLyLichTable({ searchData });
  ...
  return (
    <>
      ...
      {modalVisible ? <TraCuuLyLichDetailModal /> : <></>}
    </>
  );
};
