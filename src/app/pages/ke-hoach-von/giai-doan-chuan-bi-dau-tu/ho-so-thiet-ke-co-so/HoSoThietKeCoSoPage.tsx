...
import { HoSoThietKeCoSoTable } from './components/HoSoThietKeCoSoTable';
import { HoSoThietKeCoSoModal } from './components/HoSoThietKeCoSoModal';

export const HoSoThietKeCoSoPage = () => {
        ...
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">
              Quản lý thông tin bước thực hiện hồ sơ thiết kế cơ sở (2 bước)
            </h3>
          ...
          <div className="card-body p-0">
            <HoSoThietKeCoSoTable searchData={searchData} />
          </div>
        </div>
      </Content>
      <HoSoThietKeCoSoModal />
    </>
  );
};
