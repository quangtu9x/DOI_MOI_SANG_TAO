...
import { GiayChungNhanTable } from './components/GiayChungNhanTable';

export const GiayChungNhanPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thông tin Quản lý chứng nhận đăng ký kết quả nghiên cứu khoa học cấp tỉnh'}</h3>
          ...
          <GiayChungNhanTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
