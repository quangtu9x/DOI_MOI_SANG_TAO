...
import { NhiemVuKhaoSatTable } from './components/NhiemVuKhaoSatTable';
import { NhiemVuKhaoSatModal } from './components/NhiemVuKhaoSatModal';

export const NhiemVuKhaoSatPage = () => {
        ...
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">
              Quản lý thông tin bước thực hiện nhiệm vụ khảo sát
            </h3>
          ...
          <div className="card-body p-0">
            <NhiemVuKhaoSatTable searchData={searchData} />
          </div>
        </div>
      </Content>
      <NhiemVuKhaoSatModal />
