...
import { ProjectTypeDetailModal } from './components/ProjectTypeDetailModal';

export const DanhMucLoaiDuAnPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Danh mục loại dự án'}</h3>
          ...
          <ProjectTypeTable searchData={searchData} />
        </div>
