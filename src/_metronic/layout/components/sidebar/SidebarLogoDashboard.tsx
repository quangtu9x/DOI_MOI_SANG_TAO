...
const SidebarLogoDashboard = (props: PropsType) => {
  const { config } = useLayout()
  const toggleRef = useRef<HTMLDivElement>(null)

  const appSidebarDefaultMinimizeDesktopEnabled = false
  ...
  return (
    <div className='app-sidebar-logo px-4' id='kt_app_sidebar_logo'>
      <Link to='/'>
        ...
        <img
          alt='Logo'
          src={toAbsoluteUrl('media/logos/logo-minimize.png')}
