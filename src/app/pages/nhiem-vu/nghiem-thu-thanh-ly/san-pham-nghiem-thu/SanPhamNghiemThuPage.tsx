...
import { SanPhamNghiemThuTable } from './components/SanPhamNghiemThuTable';

export const SanPhamNghiemThuPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thông tin Sản phẩm và kết quả đạt được'}</h3>
          ...
          <SanPhamNghiemThuTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
