...
import { QuaTrinhNghienCuuTable } from './components/QuaTrinhNghienCuuTable';

export const QuaTrinhNghienCuuPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Danh sách thông tin quá trình nghiên cứu, nhiệm vụ KHCN đã thực hiện, công bố khoa học'}</h3>
          ...
          <QuaTrinhNghienCuuTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
