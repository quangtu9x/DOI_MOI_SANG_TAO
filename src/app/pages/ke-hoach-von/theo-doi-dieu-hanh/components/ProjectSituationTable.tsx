...
import { useProjectSituationTable } from './useProjectSituationTable';
...
interface ProjectSituationTableProps {
...
export const ProjectSituationTable: React.FC<ProjectSituationTableProps> = ({ searchData }) => {
  const dispatch: AppDispatch = useDispatch();
  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } =
    useProjectSituationTable({ searchData });
