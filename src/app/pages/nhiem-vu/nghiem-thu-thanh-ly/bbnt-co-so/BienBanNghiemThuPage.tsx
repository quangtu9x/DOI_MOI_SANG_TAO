...
import { BienBanNghiemThuTable } from './components/BienBanNghiemThuTable';

export const BienBanNghiemThuPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thông tin Biên bản nghiệm thu cơ sở'}</h3>
          ...
          <BienBanNghiemThuTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
