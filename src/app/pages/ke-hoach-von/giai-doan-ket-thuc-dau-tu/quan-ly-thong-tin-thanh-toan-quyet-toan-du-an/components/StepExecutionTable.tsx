...
import { useStepExecutionTable } from './useStepExecutionTable';

interface StepExecutionTableProps {
...
export const StepExecutionTable: React.FC<StepExecutionTableProps> = ({
  searchData,
  projectProcessExecutionId,
}) => {
  const dispatch: AppDispatch = useDispatch();
  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } =
    useStepExecutionTable({ searchData, projectProcessExecutionId });
