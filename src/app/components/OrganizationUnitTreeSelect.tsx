...
export type OrganizationUnitNode = IOrganizationUnit & { parentCode?: string | null };
...
export interface OrganizationUnitTreeSelectProps extends Omit<TreeSelectProps, 'treeData' | 'loading'> {
...
export const OrganizationUnitTreeSelect = ({
    fetchOrganizationUnits,
    useCurrentUserDefault = true,
    ...restProps
}: OrganizationUnitTreeSelectProps) => {
...
export default OrganizationUnitTreeSelect;
