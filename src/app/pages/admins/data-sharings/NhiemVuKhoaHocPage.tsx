...
export const NhiemVuKhoaHocPage = () => {
    ...
    const fetchData = useCallback(async () => {
        try {
            ...
            const response = await requestPOST<IPaginationResponse<IDataSharing[]>>('DataSharings/search', {
                pageNumber: 1,
                pageSize: 10,
                dataSharingTypeCode: DATA_SHARING_CODE.NHIEM_VU_KHOA_HOC
            });
        ...
        <Content>
            <div className="card card-xl-stretch">
                <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
                    <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Tích hợp và chia sẻ dữ liệu nhiệm vụ khoa học'}</h3>
