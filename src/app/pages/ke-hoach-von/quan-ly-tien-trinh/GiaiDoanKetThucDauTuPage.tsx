...
export const GiaiDoanKetThucDauTuPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Giai đoạn kết thúc đầu tư'}</h3>
          ...
          <div className="card-body">
            <p className="text-muted">Nội dung trang Giai đoạn kết thúc đầu tư</p>
          </div>
        </div>
      </Content>
    </>
