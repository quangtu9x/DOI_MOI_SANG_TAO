...
import { BienBanKiemPhieuTable } from './components/BienBanKiemPhieuTable';

export const BienBanKiemPhieuPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thông tin Kiểm phiếu đánh giá hồ sơ đăng ký tuyển chọn/ giao trực tiếp tổ chức và cá nhân thực hiện nhiệm vụ KH&CN'}</h3>
          ...
          <BienBanKiemPhieuTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
