...
export const BienBanMoHoSoDetailModalOld = props => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (_data) {
          var dangKyChuTris = _data?.dangKyChuTris || [];
          form.setFieldsValue({
            tinhTrangTruocKhiRaSoats: dangKyChuTris.map(item => ({
                      ...
                      <table className="table table-bordered">
                        <thead className="table-light">
                          <tr>
                            ...
                            <th rowSpan={2} className="text-center align-middle" >Tên cá nhân đăng ký tuyển chọn</th>
                                ...
                                >
                                  <UserSelect
                                    ...
                                    onUserIdChange={(userId) => {
                                      if (userId) {
                                        form.setFieldValue(['tinhTrangTruocKhiRaSoats', name, 'nguoiDangKyId'], userId);
                                      } else {
                                        form.setFieldValue(['tinhTrangTruocKhiRaSoats', name, 'nguoiDangKyId'], null);
                                      }
                                    }}
                                  />
                                </Form.Item>
                              ...
                              <td>
                                ...
                                >
                                  <UserSelect
                                    ...
                                    onUserIdChange={(userId) => {
                                      if (userId) {
                                        form.setFieldValue(['tinhTrangSauKhiRaSoats', name, 'nguoiDangKyId'], userId);
                                      } else {
                                        form.setFieldValue(['tinhTrangSauKhiRaSoats', name, 'nguoiDangKyId'], null);
                                      }
                                    }}
                                  />
                                </Form.Item>
                      ...
                      <table className="table table-bordered">
                        <thead className="table-light">
                          <tr>
                            ...
                            <th className="text-center align-middle" >Tên cá nhân đăng ký tuyển chọn</th>
                              ...
                              <td>
                                ...
                                >
                                  <UserSelect
                                    ...
                                    onUserIdChange={(userId) => {
                                      if (userId) {
                                        form.setFieldValue(['hoSoHopLes', name, 'nguoiDangKyId'], userId);
                                      } else {
                                        form.setFieldValue(['hoSoHopLes', name, 'nguoiDangKyId'], null);
                                      }
                                    }}
                                  />
                                </Form.Item>
