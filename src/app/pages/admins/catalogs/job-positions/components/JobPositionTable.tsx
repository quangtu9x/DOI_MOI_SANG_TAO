...
import { JobPositionDetailModal } from './JobPositionDetailModal';
import { useJobPositionTable } from './useJobPositionTable';

interface CategoryTableProps {
  searchData?: SearchData;
}

export const JobPositionTable: React.FC<CategoryTableProps> = ({ searchData }) => {
  const dispatch: AppDispatch = useDispatch();
  const modalVisible = useSelector((state: RootState) => state.modal.modalVisible);

  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize, categoryGroupId } = useJobPositionTable({ searchData });
  ...
  return (
    <>
      ...
      {modalVisible ? <JobPositionDetailModal totalCount={totalCount} categoryGroupId={categoryGroupId} /> : <></>}
    </>
  );
};
