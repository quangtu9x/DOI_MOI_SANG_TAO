...
import { BienBanMoHoSoTable } from './components/BienBanMoHoSoTable';

export const BienBanMoHoSoPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thông tin Biên bản mở hồ sơ đăng ký tuyển chọn tổ chức/ cá nhân chủ trì nhiệm vụ KH&CN'}</h3>
          ...
          <BienBanMoHoSoTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
