...
export const ThongTinChungDetailModal = () => {
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const transformedForeignLanguages: ITrinhDoNgoaiNgu[] = values.trinhDoNgoaiNgus?.map((lang: ITrinhDoNgoaiNguFormItem) => {
            ...
            <Form<IChuyenGia>
              ...
              <>
                ...
                <div className="row">
                  ...
                  <div className="col-xl-4 col-lg-4">
                    <Form.Item label="Mã ngạch" name="maNgach"
                      rules={[
                        { required: true, message: "Không được để trống!" },
                      ]}>
                      <TDSelect
                        ...
                        fetchOptions={async keyword => {
                          const res = await requestPOST<IPaginationResponse<any[]>>(`categories/search`, {
                            ...
                            pageSize: 1000,
                            keyword: keyword,
                            categoryGroupCode: CATEGORY_GROUP_CODE.MA_NGACH,
                          });
                          return (
                        ...
                        onChange={(value, current: any) => {
                          if (value) {
                            form.setFieldValue('maNgachId', current?.id);
                          } else {
                            form.setFieldValue('maNgachId', null);
                          }
                        }}
                      />
                    </Form.Item>
