    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1 text-white'>Số lượng đăng ký mới xe cơ giới</span>
      ...
      <div className='card-body'>
        {/* begin::Chart */}
        <div ref={chartRef} id='kt_charts_widget_4_chart' style={{ height: '250px' }}></div>
        {/* end::Chart */}
      </div>
      {/* end::Body */}
    </div>
...
function getChartOptions(height: number): ApexOptions {
  ...
  return {
    series: [{
      name: 'Xe Ô tô',
      data: [1200, 1450, 1320, 1800, 1680, 1080]
    }, {
      name: 'Xe máy',
      data: [1300, 2300, 2000, 800, 1300, 2700]
    }],
    chart: {
      fontFamily: 'inherit',
      type: 'bar',
