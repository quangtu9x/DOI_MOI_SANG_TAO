...
import { IProjectDecision } from '@/models';
import { TDTable } from '@/app/components';
import { deleteProjectDecision } from '@/services/projectDecision.service';
import { useQuyetDinhDauTuDuAnTable } from './useQuyetDinhDauTuDuAnTable';

interface QuyetDinhDauTuDuAnTableProps {
  searchData?: SearchData;
}

export const QuyetDinhDauTuDuAnTable: React.FC<QuyetDinhDauTuDuAnTableProps> = ({
  searchData,
}) => {
  const dispatch: AppDispatch = useDispatch();
  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } =
    useQuyetDinhDauTuDuAnTable({ searchData });
