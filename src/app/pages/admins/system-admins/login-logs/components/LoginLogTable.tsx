...
const getLoginLogTypeColor = (type?: string) => (type === 'Logout' ? 'badge-light-warning' : 'badge-light-success');
...
export const LoginLogTable: React.FC<LoginLogProps> = ({ searchData }) => {
  ...
  const columns: TableProps<ILoginLog>['columns'] = [
    ...
    },
    {
      ...
      width: 130,
      className: 'text-center',
      render: type => <span className={`badge ${getLoginLogTypeColor(type)}`}>{getLoginLogTypeLabel(type)}</span>,
    },
