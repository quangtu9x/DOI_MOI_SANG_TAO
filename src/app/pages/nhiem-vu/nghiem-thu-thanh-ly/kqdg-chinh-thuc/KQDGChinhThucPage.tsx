...
import { KQDGChinhThucTable } from './components/KQDGChinhThucTable';

export const KQDGChinhThucPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thông tin Kết quả đánh giá nghiệm thu của Hội đồng'}</h3>
          ...
          <KQDGChinhThucTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
