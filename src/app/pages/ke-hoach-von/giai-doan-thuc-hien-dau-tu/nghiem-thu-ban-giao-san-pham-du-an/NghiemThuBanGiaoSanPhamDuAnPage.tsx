...
import { NghiemThuBanGiaoSanPhamTable } from './components/NghiemThuBanGiaoSanPhamTable';
import { NghiemThuBanGiaoSanPhamModal } from './components/NghiemThuBanGiaoSanPhamModal';

export const NghiemThuBanGiaoSanPhamDuAnPage = () => {
        ...
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">
              Quản lý thông tin nghiệm thu, bàn giao sản phẩm của dự án
            </h3>
          ...
          <div className="card-body p-0">
            <NghiemThuBanGiaoSanPhamTable searchData={searchData} />
          </div>
        </div>
      </Content>
      <NghiemThuBanGiaoSanPhamModal />
    </>
  );
};
