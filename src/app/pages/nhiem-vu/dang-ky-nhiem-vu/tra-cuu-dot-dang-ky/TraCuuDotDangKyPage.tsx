...
import { DotDangKyTable } from './components/DotDangKyTable';

export const TraCuuDotDangKyPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Đợt đăng ký nhiệm vụ KHCN'}</h3>
          ...
          <DotDangKyTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
