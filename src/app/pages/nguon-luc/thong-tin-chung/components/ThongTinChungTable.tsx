...
import { useThongTinChungTable } from './useThongTinChungTable';
import { ThongTinChungDetailModal } from './ThongTinChungDetailModal';
...
export const ThongTinChungTable: React.FC<DataTableProps> = ({ searchData }) => {
  const dispatch: AppDispatch = useDispatch();
  const modalVisible = useSelector((state: RootState) => state.modal.modalVisible);

  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } = useThongTinChungTable({ searchData });
  ...
  return (
    <>
      ...
      {modalVisible ? <ThongTinChungDetailModal /> : <></>}
    </>
  );
};
