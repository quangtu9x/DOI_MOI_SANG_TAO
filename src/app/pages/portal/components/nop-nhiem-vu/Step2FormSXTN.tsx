...
export const Step2FormSXTN: React.FC<Props> = ({ form, onFinish, setStep, currentUser }) => {
    return (
        <Form
            form={form}
            layout="vertical"
        ...
        >
            <div className="text-center mb-10">
                ...
                <h3 className="text-[20px] font-bold uppercase text-[#18191c] mt-1">DỰ ÁN SẢN XUẤT THỬ NGHIỆM</h3>
            </div>
                    ...
                    <Form.Item
                        ...
                        label={
                            <span className="font-medium text-gray-800 text-[14px]">
                                1. Tên dự án SXTN: <span className="text-red-500 ml-1">*</span>
                            </span>
                        }
            ...
            <div>
                ...
                <div className="grid grid-cols-1 gap-4 text-[14px]">
                    <Form.Item
                        ...
                        label={
                            <span className="font-medium text-gray-800 text-[14px] leading-relaxed">
                                1. Xuất xứ hình thành <span className="font-normal italic text-gray-600">(kết quả của các đề tài / kết quả khai thác sáng chế, giải pháp hữu ích / kết quả KH&CN chuyển giao từ nước ngoài... có khả năng ứng dụng):</span>
                            </span>
                        }
                    >
                        <Radio.Group className="pl-4 flex flex-col gap-2 mt-2">
                            <Radio value="1">Kết quả của các đề tài</Radio>
                            <Radio value="2">Kết quả khai thác sáng chế, giải pháp hữu ích</Radio>
                            <Radio value="3">Kết quả KH&CN chuyển giao từ nước ngoài...</Radio>
                        </Radio.Group>
                    </Form.Item>
                    ...
                    <Form.Item
                        ...
                        label={
                            <span className="font-medium text-gray-800 text-[14px]">
                                4. Kiến nghị các nội dung chính cần thực hiện để hoàn thiện công nghệ và đạt kết quả: <span className="text-red-500 ml-1">*</span>
                            </span>
                        }
                    ...
                    <Form.Item
                        ...
                        label={
                            <span className="font-medium text-gray-800 text-[14px]">
                                5. Yêu cầu đối với kết quả (công nghệ, thiết bị) và các chỉ tiêu kỹ thuật cần đạt: <span className="text-red-500 ml-1">*</span>
                            </span>
                        }
                    ...
                    <Form.Item
                        name="nhuCauThiTruong"
                        label={
                            <span className="font-medium text-gray-800 text-[14px] leading-relaxed">
                                6. Nhu cầu thị trường: <span className="font-normal italic text-gray-600">(Khả năng thị trường tiêu thụ, phương thức chuyển giao và thương mại hoá các sản phẩm của dự án)</span> <span className="text-red-500 ml-1">*</span>
                            </span>
                        }
                        rules={[{ required: true, message: "Vui lòng nhập nhu cầu thị trường!" }]}
                    >
                        <Input.TextArea size="large" rows={4} />
                    </Form.Item>
                    ...
                    <Form.Item
                        name="yeuCauThoiGian"
                        label={
                            <span className="font-medium text-gray-800 text-[14px]">8. Yêu cầu đối với thời gian thực hiện:</span>
                        }
                    >
                        <Input.TextArea size="large" rows={3} />
                    </Form.Item>
                    ...
                    <Form.Item
                        ...
                        label={
                            <span className="font-medium text-gray-800 text-[14px] leading-relaxed">
                                9. Phương án huy động các nguồn lực của tổ chức dự kiến ứng dụng kết quả tạo ra: <span className="font-normal italic text-gray-600">(Khả năng huy động nhân lực, tài chính và cơ sở vật chất từ các nguồn khác nhau để thực hiện dự án)</span>
                            </span>
                        }
                    >
                        <Input.TextArea size="large" rows={4} />
                    ...
                    <Form.Item
                        name="kinhPhi"
                        label={<span className="font-medium text-gray-800 text-[14px]">10. Dự kiến nhu cầu kinh phí (VNĐ):</span>}
                    >
