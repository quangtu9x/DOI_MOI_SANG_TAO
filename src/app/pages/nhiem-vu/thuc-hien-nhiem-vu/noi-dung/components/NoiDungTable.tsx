...
import { useHoSoThamDinhTable } from './useNoiDungTable';
import { NoiDungDetailModal } from './NoiDungDetailModal';
import { formatNumber, toViewDateString } from '@/utils/utils';

interface NoiDungTableProps {
  searchData?: SearchData;
}

export const NoiDungTable: React.FC<NoiDungTableProps> = ({ searchData }) => {
  ...
  const columns: TableProps<IHoSoThamDinh>['columns'] = [
    ...
    },
    {
      ...
      dataIndex: 'keHoachThucHiens',
      key: 'keHoachThucHiens',
      className: 'text-center',
      width: '15%',
  ...
  return (
    <>
      ...
      {modalVisible ? <NoiDungDetailModal totalCount={totalCount} /> : <></>}
    </>
  );
};