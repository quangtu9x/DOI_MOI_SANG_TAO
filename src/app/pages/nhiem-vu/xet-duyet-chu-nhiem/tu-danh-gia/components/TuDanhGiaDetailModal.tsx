...
import { IBienBanMoHoSo, IChiTietMoHoSo, IHoanThienHoSo, IPaginationResponse, IResult, LoaiChiTietMoHoSo } from '@/models';
...
export const TuDanhGiaDetailModal = props => {
  ...
  useEffect(() => {
    const fetchData = async (): Promise<void> => {
      try {
        ...
        if (_data) {
          setDinhKem(handleImage(_data?.dinhKemBaoCaoGiaiTrinh ?? ''));
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const formData: IHoanThienHoSo = {
        ...values,
        ...(id && { id }),
        dinhKemBaoCaoGiaiTrinh: handleFiles(dinhKem).join('##'),
      };
            ...
            <Form<IHoanThienHoSo>
              ...
              <div className="row">
                ...
                <div className="col-xl-12 col-lg-12">
                  <Form.Item label="Báo cáo giải trình" name="baoCaoGiaiTrinh" rules={[{ required: true, message: 'Không được để trống!' }]}>
                ...
                <div className="col-xl-4 col-lg-4">
                  <Form.Item
                    label="Đính kèm báo cáo giải trình"
                    name='dinhKemBaoCaoGiaiTrinh'
                  >
                    <FileUpload
