...
export const useProjectSituationTable = ({ searchData, initialPageSize = 50 }: UseDataTableProps) => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const searchRequest: ISearchProjectDifficultyRequest = {
        ...
        category: ProjectDifficultyCategory.ProjectSituation, // Cố định category = 1 (Tình hình dự án)
      ...
      console.error('Error fetching project situations:', error);
