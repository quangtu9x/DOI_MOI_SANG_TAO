...
import { IPaginationResponse, IHoSoSangKien, TrangThaiHoSoSangKien } from '@/models';
...
export const useDanhGiaSangKienTable = ({ searchData, initialPageSize = 50 }: UseDataTableProps) => {
