...
import { BaoCaoNghienCuuTienKhaThiTable } from './components/BaoCaoNghienCuuTienKhaThiTable';
import { BaoCaoNghienCuuTienKhaThiModal } from './components/BaoCaoNghienCuuTienKhaThiModal';

export const BaoCaoNghienCuuTienKhaThiPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          ...
          <div className="card-body p-0">
            <BaoCaoNghienCuuTienKhaThiTable searchData={searchData} />
          </div>
        </div>
      </Content>
      <BaoCaoNghienCuuTienKhaThiModal />
    </>
  );
};
