...
import { QuyetDinhChuTruongDauTuTable } from './components/QuyetDinhChuTruongDauTuTable';
import { QuyetDinhChuTruongDauTuModal } from './components/QuyetDinhChuTruongDauTuModal';

export const QuyetDinhChuTruongDauTuPage = () => {
  ...
  const handleAddDecision = (): void => {
    dispatch(actionsModal.setDataModalCapBon({ readOnly: false, type: DecisionType.InvestmentPolicy }));
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          ...
          <div className="card-body p-0">
            <QuyetDinhChuTruongDauTuTable searchData={searchData} />
          </div>
        </div>
      </Content>
