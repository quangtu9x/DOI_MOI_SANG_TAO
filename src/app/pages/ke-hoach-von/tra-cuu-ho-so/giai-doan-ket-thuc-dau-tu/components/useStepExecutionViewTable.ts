...
interface UseStepExecutionViewTableProps {
...
export const useStepExecutionViewTable = ({
  searchData,
  ...
  phase,
  initialPageSize = 50,
}: UseStepExecutionViewTableProps) => {
  ...
  }, [currentPage, pageSize, searchData, projectProcessExecutionId, stepType, stepTypes, phase]);
