...
import { useBaoCaoKinhTeKyThuatTable } from './useBaoCaoKinhTeKyThuatTable';

interface BaoCaoKinhTeKyThuatTableProps {
...
export const BaoCaoKinhTeKyThuatTable: React.FC<BaoCaoKinhTeKyThuatTableProps> = ({
  searchData,
  projectProcessExecutionId,
}) => {
  const dispatch: AppDispatch = useDispatch();
  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } =
    useBaoCaoKinhTeKyThuatTable({ searchData, projectProcessExecutionId });
