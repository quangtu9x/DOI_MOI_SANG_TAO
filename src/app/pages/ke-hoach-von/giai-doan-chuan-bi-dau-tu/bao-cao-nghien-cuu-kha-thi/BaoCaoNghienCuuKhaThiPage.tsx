...
import { BaoCaoNghienCuuKhaThiTable } from './components/BaoCaoNghienCuuKhaThiTable';
import { BaoCaoNghienCuuKhaThiModal } from './components/BaoCaoNghienCuuKhaThiModal';

export const BaoCaoNghienCuuKhaThiPage = () => {
        ...
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">
              Quản lý thông tin bước thực hiện báo cáo nghiên cứu khả thi dự án
            </h3>
          ...
          <div className="card-body p-0">
            <BaoCaoNghienCuuKhaThiTable searchData={searchData} />
          </div>
        </div>
      </Content>
      <BaoCaoNghienCuuKhaThiModal />
    </>
  );
};
