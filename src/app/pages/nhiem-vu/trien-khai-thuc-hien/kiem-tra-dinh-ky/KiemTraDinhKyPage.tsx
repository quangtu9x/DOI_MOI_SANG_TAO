...
import { KiemTraDinhKyTable } from './components/KiemTraDinhKyTable';

export const KiemTraDinhKyPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thông tin Thông tin kiểm tra định kỳ'}</h3>
          ...
          <KiemTraDinhKyTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
