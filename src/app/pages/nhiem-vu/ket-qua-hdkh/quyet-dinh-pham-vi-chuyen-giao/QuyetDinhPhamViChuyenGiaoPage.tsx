...
import { QuyetDinhPhamViChuyenGiaoTable } from './components/QuyetDinhPhamViChuyenGiaoTable';

export const QuyetDinhPhamViChuyenGiaoPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Quản lý thông tin quyết định phạm vi, đối tượng chuyển giao'}</h3>
          ...
          <QuyetDinhPhamViChuyenGiaoTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
