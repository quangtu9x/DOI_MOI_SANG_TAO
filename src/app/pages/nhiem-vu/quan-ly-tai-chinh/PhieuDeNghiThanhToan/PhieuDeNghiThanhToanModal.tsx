...
import { IPhieuDeNghiThanhToan, IResult, TrangThaiPhieu, IPaginationResponse } from '@/models';
...
export const PhieuDeNghiThanhToanModal = () => {
  ...
  useEffect(() => {
    const fetchData = async (): Promise<void> => {
      try {
        setIsLoading(true);
        const response = await requestGET<IResult<any>>(`PhieuDeNghiThanhToans/${id}`);
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const formData: IPhieuDeNghiThanhToan = {
        ...values,
        id: id,
      ...
      const response = id
        ? await requestPUT<IResult<string>>(`PhieuDeNghiThanhToans/${id}`, formData)
        : await requestPOST<IResult<string>>(`PhieuDeNghiThanhToans`, formData);
    ...
    >
      <Modal.Header className="bg-primary px-4 py-3">
        <Modal.Title className="text-white">
          {dataModal?.readOnly ? 'Chi tiết' : id ? 'Chỉnh sửa' : 'Tạo mới'} phiếu đề nghị thanh toán
        </Modal.Title>
          ...
          {!isLoading && (
            ...
            >
              <div className="row">
                ...
                <div className="col-xl-4 col-lg-6">
                  <Form.Item label="Đợt thanh toán" name="dotThanhToan">
                ...
                <div className="col-xl-12 col-lg-12">
                  <Form.Item label="Nội dung thanh toán" name="noiDungThanhToan">
