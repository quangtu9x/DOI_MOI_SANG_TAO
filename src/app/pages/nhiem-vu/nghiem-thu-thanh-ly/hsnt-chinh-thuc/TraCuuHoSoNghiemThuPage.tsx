...
import { HoSoNghiemThuTable } from './components/HoSoNghiemThuTable';
import { buildExportPayload, exportList, printList } from '../exportPrintListHelpers';

const EXPORT_ENDPOINT = 'HoSoNghiemThus/export';
const PRINT_TITLE = 'Danh sách hồ sơ nghiệm thu chính thức';

export const TraCuuHoSoNghiemThuPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Tra cứu hồ sơ nghiệm thu chính thức'}</h3>
          ...
          <HoSoNghiemThuTable searchData={searchData} readOnly={true} />
        </div>
      </Content>
    </>
  );
