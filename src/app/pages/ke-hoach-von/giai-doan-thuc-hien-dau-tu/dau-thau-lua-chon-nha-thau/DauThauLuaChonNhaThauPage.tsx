...
import { DauThauLuaChonNhaThauTable } from './components/DauThauLuaChonNhaThauTable';
import { DauThauLuaChonNhaThauModal } from './components/DauThauLuaChonNhaThauModal';

export const DauThauLuaChonNhaThauPage = () => {
        ...
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">
              Quản lý thông tin bước thực hiện đấu thầu, lựa chọn nhà thầu
            </h3>
          ...
          <div className="card-body p-0">
            <DauThauLuaChonNhaThauTable searchData={searchData} />
          </div>
        </div>
      </Content>
      <DauThauLuaChonNhaThauModal />
    </>
  );
};
