...
import { useNghiemThuBanGiaoSanPhamTable } from './useNghiemThuBanGiaoSanPhamTable';

interface NghiemThuBanGiaoSanPhamTableProps {
...
export const NghiemThuBanGiaoSanPhamTable: React.FC<NghiemThuBanGiaoSanPhamTableProps> = ({
  searchData,
  projectProcessExecutionId,
}) => {
  const dispatch: AppDispatch = useDispatch();
  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } =
    useNghiemThuBanGiaoSanPhamTable({ searchData, projectProcessExecutionId });
