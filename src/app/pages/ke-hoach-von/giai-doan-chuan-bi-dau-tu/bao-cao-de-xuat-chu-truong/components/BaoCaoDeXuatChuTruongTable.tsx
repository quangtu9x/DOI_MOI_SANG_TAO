...
import { useBaoCaoDeXuatChuTruongTable } from './useBaoCaoDeXuatChuTruongTable';

interface BaoCaoDeXuatChuTruongTableProps {
...
export const BaoCaoDeXuatChuTruongTable: React.FC<BaoCaoDeXuatChuTruongTableProps> = ({
  searchData,
  projectProcessExecutionId,
}) => {
  const dispatch: AppDispatch = useDispatch();
  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } =
    useBaoCaoDeXuatChuTruongTable({ searchData, projectProcessExecutionId });
