...
import { KQDGCoSoTable } from './components/KQDGCoSoTable';

export const KQDGCoSoPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thông tin Kết quả đánh giá của hội đồng/chuyên gia'}</h3>
          ...
          <KQDGCoSoTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
