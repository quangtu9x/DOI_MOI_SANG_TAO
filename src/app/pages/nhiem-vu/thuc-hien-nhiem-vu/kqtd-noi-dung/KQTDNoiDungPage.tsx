...
import { KQTDNoiDungTable } from './components/KQTDNoiDungTable';

export const KQTDNoiDungPage = () => {
      ...
      <Content>
        <div className="card card-xl-stretch mb-xl-9">
          <div className="px-3 py-3 border-bottom border-secondary border-bottom-solid d-flex align-items-center justify-content-between">
            <h3 className="card-title fw-bold text-header-td fs-4 mb-0">{'Thông tin Kết quả thẩm định nội dung'}</h3>
          ...
          <KQTDNoiDungTable searchData={searchData} />
        </div>
      </Content>
    </>
  );
