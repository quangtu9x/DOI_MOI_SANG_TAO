...
import { useHoSoThamDinhTable } from './useKQTDNoiDungTable';
import { KQTDNoiDungDetailModal } from './KQTDNoiDungDetailModal';
import { formatNumber } from '@/utils/utils';

interface KQTDNoiDungTableProps {
  searchData?: SearchData;
}

export const KQTDNoiDungTable: React.FC<KQTDNoiDungTableProps> = ({ searchData }) => {
  ...
  return (
    <>
      ...
      {modalVisible ? <KQTDNoiDungDetailModal totalCount={totalCount} /> : <></>}
    </>
  );
};