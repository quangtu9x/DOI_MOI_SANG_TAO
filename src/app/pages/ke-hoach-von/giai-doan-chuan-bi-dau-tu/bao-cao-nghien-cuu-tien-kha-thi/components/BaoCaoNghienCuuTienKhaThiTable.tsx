...
import { useBaoCaoNghienCuuTienKhaThiTable } from './useBaoCaoNghienCuuTienKhaThiTable';

interface BaoCaoNghienCuuTienKhaThiTableProps {
...
export const BaoCaoNghienCuuTienKhaThiTable: React.FC<BaoCaoNghienCuuTienKhaThiTableProps> = ({
  searchData,
  projectProcessExecutionId,
}) => {
  const dispatch: AppDispatch = useDispatch();
  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } =
    useBaoCaoNghienCuuTienKhaThiTable({ searchData, projectProcessExecutionId });
