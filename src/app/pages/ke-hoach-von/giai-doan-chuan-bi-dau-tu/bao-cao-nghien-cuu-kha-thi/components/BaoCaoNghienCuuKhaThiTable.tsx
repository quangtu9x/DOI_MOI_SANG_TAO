...
import { useBaoCaoNghienCuuKhaThiTable } from './useBaoCaoNghienCuuKhaThiTable';

interface BaoCaoNghienCuuKhaThiTableProps {
...
export const BaoCaoNghienCuuKhaThiTable: React.FC<BaoCaoNghienCuuKhaThiTableProps> = ({
  searchData,
  projectProcessExecutionId,
}) => {
  const dispatch: AppDispatch = useDispatch();
  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } =
    useBaoCaoNghienCuuKhaThiTable({ searchData, projectProcessExecutionId });
