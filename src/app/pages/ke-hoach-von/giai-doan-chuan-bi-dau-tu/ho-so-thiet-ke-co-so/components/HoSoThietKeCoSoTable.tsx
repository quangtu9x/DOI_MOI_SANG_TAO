...
import { useHoSoThietKeCoSoTable } from './useHoSoThietKeCoSoTable';

interface HoSoThietKeCoSoTableProps {
...
export const HoSoThietKeCoSoTable: React.FC<HoSoThietKeCoSoTableProps> = ({
  searchData,
  projectProcessExecutionId,
}) => {
  const dispatch: AppDispatch = useDispatch();
  const { data, loading, totalCount, currentPage, pageSize, setCurrentPage, setPageSize } =
    useHoSoThietKeCoSoTable({ searchData, projectProcessExecutionId });
